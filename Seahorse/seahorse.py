            ...
            if m:
                ...
                if cmd == "ignore":
                    if name not in self.__ignore:
                        self.msg(self.__channel, "Neigh...  (translation: Now ignoring %s)" % name)
                    ...
                    if name in self.__ignore:
                        self.msg(self.__channel, 
                                "Neigh!  (translation: Oh hi %s. How long have you been here?)" % m.group(2))
